...
def control_panel():
    ...
    image_of_rectangle = pygame.image.load("images/rectangle.png")
    image_of_circle = pygame.image.load("images/circle.jpg")
    image_of_ellipse = pygame.image.load("images/ellipse.png")
    # image_of_line = pygame.image.load("images/line.png")
    image_of_palette = pygame.image.load("images/palette.jpg")
