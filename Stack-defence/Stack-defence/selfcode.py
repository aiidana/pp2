...
boss2=pygame.image.load("Boss2.png").convert()
boss=pygame.transform.scale(boss, (200,200))
boss2=pygame.transform.scale(boss2, (200,200))
bg=pygame.transform.scale(bg, (width,height))
effect = pygame.mixer.Sound('stack.wav')
effect2 = pygame.mixer.Sound('stack2.wav')
boss_sound=pygame.mixer.Sound('Boss_sound.wav')
boss_sound2=pygame.mixer.Sound('Boss_sound2.wav')
